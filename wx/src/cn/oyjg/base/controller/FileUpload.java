...
public class FileUpload {
	...
	// kingeditor编辑器的文件上传,
	@RequestMapping(value = "KingUploadFile")
	public String uploadFile(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		
		PrintWriter out=response.getWriter();
		//文件保存目录路径
		String savePath = request.getSession().getServletContext().getRealPath("/") + "kindEditorAttached/";
	...
	/**
	 * 配合ueditor上传 从百度整理出来的文件上传方法,将文件上传到用户名目录下
	 */
	...
	public void imageManager(HttpServletRequest request,
		...
		String rootPath = request.getSession().getServletContext().getRealPath("/") + "kindEditorAttached/";
